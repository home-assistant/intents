        ...
        yaml_dump(
            {
                ...
                "responses": {
                    "errors": {
                        ...
                        "no_device": "TODO Sorry, I am not aware of any device called {{ device }}",
                        "no_device_in_area": "TODO Sorry, I am not aware of any device called {{ device }} in the {{ area }} area",
                        "no_device_exposed": "TODO Sorry, {{ device }} is not exposed",
                        "no_device_in_area_exposed": "TODO Sorry, {{ device }} in the {{ area }} area is not exposed",
                        ...
                        "duplicate_devices": "TODO Sorry, there are multiple devices called {{ device }}",
                        "duplicate_devices_in_area": "TODO Sorry, there are multiple devices called {{ device }} in the {{ area }} area",
                    },
                },
                "lists": {},
                "expansion_rules": {},
